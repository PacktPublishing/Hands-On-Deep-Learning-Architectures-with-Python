...
if __name__ == '__main__':
    data_path = 'C:/Users/Admin/Desktop/deep_learning/Chapter 3/B10283_03_code/ml-1m/ml-1m/ratings.dat'
    ...
    for i in range(num_movies):
        avg_rating.append(np.mean(data_train[data_train[:, i]>0, i]))

    mean_sim = np.tile(avg_rating, (len(data_test), 1))
    print(mean_squared_error(data_test[sim_index], mean_sim[sim_index]))